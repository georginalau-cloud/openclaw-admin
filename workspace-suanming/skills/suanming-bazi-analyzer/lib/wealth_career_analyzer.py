...
def _identify_career_peaks(pillars, ten_gods_analysis, yong_shen_info):
    ...
    if strength == '旺':
        peaks['expansion_timing'] = '走食伤、财星大运时，是激进扩张的好时机'
        peaks['consolidation_timing'] = '走比劫大运时，竞争加剧，宜守成布局'
    elif strength == '弱':
        peaks['expansion_timing'] = '走印星、比劫大运时，得到助力，可适度扩张'
        peaks['consolidation_timing'] = '走财星、官杀大运时，压力较大，宜稳健守成'
    else:
        peaks['expansion_timing'] = '走用神大运时是扩张良机'
        peaks['consolidation_timing'] = '走忌神大运时宜保守应对'
