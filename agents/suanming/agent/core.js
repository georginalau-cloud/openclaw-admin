...
async function handleFeishuMessage(message) {
  ...
  if (imagePath || lower.includes('图片') || lower.includes('古籍') || lower.includes('命理') || lower.includes('看看这个')) {
    ...
    lower.includes('八字精批') || lower.includes('四柱') || lower.includes('排盘') ||
    lower.includes('格局') || lower.includes('用神') || lower.includes('大运') ||
    lower.includes('精批') || (lower.includes('八字') && lower.includes('分析'))
  ) {
    intent = 'bazi-analyzer';
